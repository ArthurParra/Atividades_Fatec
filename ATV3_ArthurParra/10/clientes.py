...
# Carrega PyMongo se disponível, ou instala automaticamente se faltar
try:
    import pymongo
except:
...
# Tela de cadastro de clientes usando MongoDB
class CadastroClientes:
    ...
    # Carrega imagens de ícones para os botões
    ...
    # Cria os botões de ação para salvar, alterar, excluir e consultar clientes
    ...
    def dados(self):
        # Retorna o dicionário de dados para salvar no MongoDB
        return {
    ...
    def salvar(self):
        # Insere novo cliente no banco e limpa o formulário
    ...
    def consultar(self):
        # Busca cliente por código e preenche os campos
        codigo = self.txt_codigo.get()
...
# Executa a tela de cadastro quando o módulo é rodado diretamente
