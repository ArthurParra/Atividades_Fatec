...
class TelaLogin:
    ...
    def criar_componentes(self):
        # Rótulos e campos de entrada para usuário e senha
    ...
    def carregar_icones(self):
        # Tenta carregar imagens para os botões
        try:
    ...
    def criar_botoes(self):
        # Botões de ação da tela de login
    ...
    def validar_acesso(self):
        # Verifica credenciais fixas e abre o menu se corretas
    ...
    def sair(self):
        # Pergunta antes de fechar a aplicação
