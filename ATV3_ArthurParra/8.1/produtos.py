...
# Classe principal para gerenciar a interface de produtos
class GestaoProdutos:
    def __init__(self):
        ...
        # Ajusta a janela ao centro da tela
    ...
    def criar_componentes(self):
        # Títulos e rótulos para os campos do cadastro de produtos
        ...
        # Campo de total só exibe o resultado e não permite edição direta
    ...
    def criar_botoes(self):
        # Tenta carregar imagens para os botões, se não encontrar usa apenas texto
        try:
        ...
        # Botão para calcular o total da venda
        Button(self.tela, text="Calcular Total", command=self.calcular_total_venda).place(x=400, y=208)

        # Botões principais de ação: cadastrar, consultar e sair
    ...
    # Método para calcular o total com base em quantidade e preço
    ...
    # Simula o cadastro de um produto
    ...
    # Simula a consulta de produto pelo código informado
