...
class Clientes:
    ...
    def configurar_tela(self):
        ...
        self.tela.configure(background="#00CFFF")
    ...
    def criar_componentes(self):
        #criar frame
        self.frame = Frame(self.tela, bg="#00E676", padx=20, pady=20)
        ...
        self.resul = Label(self.frame, text="", bg="#009688",fg="#000000", width=30, height=6, justify="center")
        self.resul.grid(row=6, column=0, columnspan=2, pady=10)
    ...
    def cadastrar_cliente(self):
        ...
        self.titulo.config(text="Dados do Cliente")
        
        self.resul.config(text=f"Nome: {self.__nome}\nEmail: {self.__email}\nTelefone: {self.__telefone}\nEndereço: {self.__endereco}")
